...
MAX_STEPS = 30_000
MODEL_PATH = "models/ppo/triangle_race_step/ppo_upwind_1M_windwardtoreach_250K_reachtoleeward_250K_reachrounding_250K_upwind_500K_downwind_500K_triangle_2M.zip"
RESULTS_DIR = "data/results"
RESULTS_PATH = os.path.join(RESULTS_DIR, "ppo_triangle_score.csv")
...
def run_ppo_episode():
    ...
    print("PPO Triangle Model running...")
