...
MAX_STEPS = 10_000
MODEL_PATH = "models/ppo/downwind_step/ppo_upwind_1M_windwardtoreach_250K_reachtoleeward_250K_reachrounding_250K_upwind_500K_downwind_500K.zip"
RESULTS_DIR = "data/results"
RESULTS_PATH = os.path.join(RESULTS_DIR, "ppo_downwind_score.csv")
...
def run_ppo_episode():
    ...
    print("PPO Downwind Model running...")
